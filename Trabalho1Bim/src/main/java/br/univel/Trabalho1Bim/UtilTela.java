...
public class UtilTela{
	...
	private int x, y;
	private Object o = new Pessoa();
	private int i;
	public int contaCol;
	
	public JPanel utilTela(final Object o){
	...
	protected TableModel Busca() {
		...
		Meutable modelo = new Meutable(x,BancoPostGre.buscarTodos(ps,new Pessoa()));
		return modelo;
	}
	...
	private String checarId() {
		...
		for (Field field : f) {
			...
			if (nomeColuna.toUpperCase().equals("ID")) {
				break;
			}
			this.i = i++;
		}
	...
	private void inserirLabel(Object o, JPanel contentPane) {
		JLabel label = null;
		Class<?> c1 = o.getClass();
		this.textFieldFiel = new ArrayList();
